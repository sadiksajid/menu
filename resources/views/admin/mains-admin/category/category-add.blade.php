...
@section('page-header')
    ...
    <div class="page-header">
        <div class="page-leftheader">
            <h4 class="page-title mb-0">Create Apk</h4>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/"><i class="fe fe-layout  mr-2 fs-14"></i>Tables</a></li>
                <li class="breadcrumb-item active" aria-current="page"><a href="">Create Apk</a></li>
            </ol>
        </div>
    </div>
    <!--End Page header-->
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Add Apk </h3>
                </div>
                <div class="card-body pb-2">
                    ...
                    @endif
                    <form action="{{ route('Apk-add') }}" method='POST' role="form" enctype="multipart/form-data">
                        @csrf
                                ...
                                <div class="col-lg-5">
                                    ...
                                    <div class="col-md-12">
                                        <select 
                                            ...
                                            @foreach ($apks as $Apk)
                                                <option value="{{ $Apk->apk_id }}">{{ $Apk->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
