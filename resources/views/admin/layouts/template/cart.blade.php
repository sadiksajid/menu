        ...
        <div class="card">
            ...
            <div class="card-body ">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <div class="d-flex w-200">
                                        <div>
                                            <img src="{{URL::asset('assets/images/products/1.jpg')}}" alt="img" title=""
                                                class="w-7 h-7">
                                        </div>
                                ...
                                <td class="text-center">
                                    <a href="javascript:void(0)" class="btn btn-danger btn-sm mr-2"
                                        data-toggle="tooltip" data-placement="top" title="Save for Washlist"><i
                                            class="fe fe-heart"></i></a>
                                    <a href="javascript:void(0)" class="btn btn-info btn-sm" data-toggle="tooltip"
                                        data-placement="top" title="Remove"><i class="fe fe-trash-2"></i></a>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <div class="d-flex w-200">
                                        <div>
                                            <img src="{{URL::asset('assets/images/products/8.jpg')}}" alt="img" title=""
                                                class="w-7 h-7">
                                        </div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex w-200">
                                        <div>
                                            <img src="{{URL::asset('assets/images/products/9.jpg')}}" alt="img" title=""
                                                class="w-7 h-7">
                                        </div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex w-200">
                                        <div>
                                            <img src="{{URL::asset('assets/images/products/4.jpg')}}" alt="img" title=""
                                                class="w-7 h-7">
                                        </div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex w-200">
                                        <div>
                                            <img src="{{URL::asset('assets/images/products/6.jpg')}}" alt="img" title=""
                                                class="w-7 h-7">
                                        </div>
                ...
                <div class=" float-right">
                    <a href="{{url('/' . $page='shop')}}" class="btn btn-info mt-2"><i class="fe fe-arrow-left"></i>
                        Continue Shopping</a>
