...
<div class="app-header header pt-0 pb-0" >
    <div class="container-fluid">
        <div class="d-flex">
            ...
            <div class="dropdown header-notify">
                    <a class="nav-link icon full-screen-link p-0" href="{{ url('/admin/dashboard') }}" data-toggle="tooltip" data-placement="bottom" title="{{ $translations['dashboard'] }}">
