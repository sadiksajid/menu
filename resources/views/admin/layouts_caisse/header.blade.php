...
<div class="app-header header pt-0 pb-0 pl-0">
    <div class="container-fluid">
        <div class="d-flex">
            ...
            <div class="dropdown header-notify">
                <a class="nav-link icon full-screen-link p-0" href="{{url('/admin/dashboard') }}" target='_black' data-toggle="tooltip"
                    data-placement="bottom" title="{{ $translations['dashboard'] }}">
                    
                    <button class='btn btn-primary btn-lg'> <i class="fa fa-bar-chart" aria-hidden="true" style='color:white' ></i></button>
            ...
            <div class="d-flex order-lg-2 ml-auto">
                ...
                <div class="dropdown   header-fullscreen">
                    <li class="submenu">
                        <a href="#" data-toggle="modal" data-target="#select_modal_language"><img class="card-img-top"
                                src="{{ asset('assets/countries/' . $flag[$current_lang] . '.svg') }}"
                    ...
                    <form action="{{ route('change_lang') }}" method="POST">
                        ...
                        <div class="row px-md-5 mb-4 d-flex justify-content-center">
                            ...
                            <div class="col-md-4 col-4 mt-2"
                                ...
                                <button type="submit" name='lang' value='{{ $lang }}' class="card p-0"
                                    style="box-shadow: 3px 2px 13px -4px rgba(0,0,0,0.75); ">
                                    <img class="card-img-top mt-2"
                                        src="{{ asset('assets/countries/' . $lang . '.svg') }}" style="height: 60px"
                                        class="card-img-top" alt="{{ $language }} flag">
                                    <p class="card-text mt-2 p-0 fs-13"
                                        style="  margin: auto;  font-weight: bold;color: #626262;">{{ $language }}</p>
                                </button>
