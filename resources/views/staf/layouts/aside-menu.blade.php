    ...
    <aside class="app-sidebar  ">
        ...
        <ul class="side-menu app-sidebar3">
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ url('/staf/caisse') }}">
                    <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24"
                        width="24">
            ...
            <li class="slide mt-3">
                <a class="side-menu__item" href="{{ url('/staf/offers') }}">
                    <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 16 16 "
                        width="24">
                        <path d="M0 0h24v24H0V0z" fill="none" />
                        <path
            ...
            <li class="slide mt-3">
                <a class="side-menu__item" href="{{ url('/staf/orders') }}">
            ...
            <li class="slide has-sub" style="width: 90%;    background-color: #ebeef1;border-radius: 40px;"> <a href="#email"  data-toggle="collapse" class="side-menu__item" style="width:100%"> <svg class="side-menu__icon"
                 ...
                 <div class="collapse" id="email">
                    <ul class="side-menu app-sidebar3">
                        <li class="slide mt-3">
                            <a class="side-menu__item" href="/staf/homeEdit">
                        ...
                        <li class="slide mt-3">
                            <a class="side-menu__item" href="/staf/MenuEdit">
                        ...
                        <li class="slide mt-3">
                            <a class="side-menu__item" href="/staf/HeadesEdit">
            ...
            {{-- <li class="slide mt-3">
                <a class="side-menu__item" href="/staf/apks">
                    <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24"
                        width="24">
            ...
            {{-- @if (Auth::User()->is_admin == 1)
                <li class="slide mt-3">
                    <a class="side-menu__item" href="{{ url('/staf/ApkToAdmin') }}">
                ...
                <li class="slide mt-3">
                    <a class="side-menu__item" href="{{ url('/staf/AppinoInfo') }}">
                        <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg"
                            enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
                            <path d="M0,0h24v24H0V0z" fill="none" />
                            <path
                ...
                <li class="slide mt-3">
                    <a class="side-menu__item" href="{{ url('/staf/StoreManage') }}">
                ...
                <li class="slide mt-3">
                    <a class="side-menu__item" href="{{ url('/staf/sendApkNotification') }}">
                        <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg"
                            enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
                            <path d="M0,0h24v24H0V0z" fill="none" />
                            <path
