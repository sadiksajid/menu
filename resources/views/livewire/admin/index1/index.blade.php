<div>
                    ...
                    <a href="#0" class="cart js-cart">
                        <button class="btn " style='  background-color: #262626;color: #fff;float: right'>
                            ...
                            <h6 class=" text-white " id='cart_price'
                                style='margin-left: 13px; font-size: 15px;float: right;margin-bottom: 2px;'>Bag</h6>
    ...
    <main>
        <div class="header-video edit-image">
            <button class="edit-button-image" data-cue="slideInUp" data-id='img_1' style='top: 50%;font-size: 180%;'><i
            ...
            <img src="{{ get_image($images['img_1'] ?? '') }}" data-video-src="{{ URL::asset('index1/video/intro') }}"
                class="header-video--media" data-teaser-source="{{ URL::asset('index1/video/intro') }}" data-provider=""
        ...
        <ul id="banners_grid" class="clearfix">
            <li class="edit-image">
                <a @if (isset($urls['url_1'])) href="{{$urls['url_1']}}" @else href="menu-1.html" @endif
                    ...
                    <button class="edit-button-image" data-cue="slideInUp" data-id='img_2'
                        style='top: 10%;font-size: 180%;'><i class="fa fa-upload"></i></button>
            ...
            <li class="edit-image">
                <a @if (isset($urls['url_2'])) href="{{$urls['url_2']}}" @else href="menu-1.html" @endif
                    ...
                    <button class="edit-button-image" data-cue="slideInUp" data-id='img_3'
                        style='top: 10%;font-size: 180%;'><i class="fa fa-upload"></i></button>
            ...
            <li class="edit-image">
                <a @if (isset($urls['url_3'])) href="{{$urls['url_3']}}" @else href="menu-1.html" @endif
                    ...
                    <img @if (isset($images['img_4'])) src="{{ get_image($images['img_4']) }}"
                        ...
                        src="{{ URL::asset('index1/img/banners_cat_placeholder.jpg') }}"
                        data-src="{{ URL::asset('index1/img/banner_1.jpg') }}" @endif alt="" class="lazy">
                    <button class="edit-button-image" data-cue="slideInUp" data-id='img_4'
                        style='top: 10%;font-size: 180%;'><i class="fa fa-upload"></i></button>

                    <div wire:ignore class="short_info opacity-mask" data-opacity-mask="rgba(0, 0, 0, 0.5)">

                        <h3 class='edit-title' data-id='title-7'> {{ $titles['en']['title-7'] ?? 'Inside Foores' }}
                        </h3>
            ...
            <div class="container margin_120_100 home_intro">
                <div class="row justify-content-center d-flex align-items-center">
                    <div class="col-lg-5 text-lg-center d-none d-lg-block " data-cue="slideInUp">
                        <figure class="edit-image">
                            <img @if (isset($images['img_5'])) src="{{ get_image($images['img_5'])}}"
                                ...
                                data-src="{{ URL::asset('index1/img/home_1.jpg') }}" @endif width="354" height="440"
                                alt="" class="img-fluid lazy">
                            <button class="edit-button-image" data-cue="slideInUp" data-id='img_5'
                                style='top: 50%;font-size: 180%;'><i class="fa fa-upload"></i></button>
                    ...
                    <a @if (isset($urls['url_4'])) href="{{$urls['url_4']}}" @else
                        ...
                        class="btn_play  edit-url" data-cue="zoomIn" data-delay="500"><span class="pulse_bt"><i
                                class="arrow_triangle-right"></i></span></a>

                    <div class="col-lg-5 pt-lg-4" data-cue="slideInUp" data-delay="500">
                        <div class="main_title">
                            <span><em></em></span>
                            <h2 class='edit-title' data-id='title-9'>
                                {{ $titles['en']['title-9'] ?? 'Some words about us' }}</h2>
                            <p class='edit-title' data-id='title-16'>
                                {{ $titles['en']['title-16'] ?? 'Cum doctus civibus efficiantur in imperdiet deterruisset.' }}
                            </p>
                        </div>
                        <div class='edit-text' data-id='text-1'>
                            <p>
                                {!! $texts['en']['text-1'] ?? 'Duis aute irure dolor in reprehenderit in voluptate velit
        ...
        <div class="bg_gray">
            <div class="container margin_120_100" data-cue="slideInUp">
                ...
                @endif
                >
                <button class="edit-button-image" data-cue="slideInUp" data-id='img_6'
                    style='top: 50%;font-size: 180%;'><i class="fa fa-upload"></i></button>

                <div wire:ignore class="wrapper d-flex align-items-center justify-content-between opacity-mask"
                    data-opacity-mask="rgba(0, 0, 0, 0.5)">
                    <div>
                        <small class='edit-title'
                            data-id='title-11'>{{ $titles['en']['title-11'] ?? ' Special Offer' }}</small>
                        <h3 class='edit-title' data-id='title-12'>
                            {{ $titles['en']['title-12'] ?? ' Burgher Menu $18 only' }}</h3>
                        <p class='edit-title' data-id='title-13'>
                            {{ $titles['en']['title-13'] ?? ' Hamburgher, Chips, Mix Sausages, Beer, Muffin' }}</p>
...
<div class="call_section lazy edit-image" @if (isset($images['img_7']))
    ...
    <button class="edit-button-image" data-cue="slideInUp" data-id='img_7' style='top: 50%;font-size: 180%;'><i
            class="fa fa-upload"></i></button>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-5 col-md-6 text-center">
                ...
                <div class="box_1" data-cue="slideInUp">
                    ...
                    <h2 class='edit-title' data-id='title-15'><span>
                            {{ $titles['en']['title-15'] ?? ' a Special Event with us!' }}</span></h2>

                    <p class='edit-text' data-id='text-2'>{!! $texts['en']['text-2'] ?? ' Nemo enim ipsam voluptatem
...
alt="" class="img-fluid">
@else
<img src="{{ URL::asset('index1/img/chef.png') }}" width="420" height="770" alt="" class="img-fluid">
@endif

<button class="edit-button-image" data-cue="slideInUp" data-id='img_8' style='top: 50%;font-size: 180%;'><i
        class="fa fa-upload"></i></button>
            ...
            <div id="middle-wizard">
                ...
                <div class="submit step">
                    ...
                    <div class="form-group terms">
                        <label class="container_check">Please accept our <a href="#" data-bs-toggle="modal"
                ...
                <div class="follow_us">
                    <ul>
                        ...
                        <li><a href="{{$this->store_info->twitter}}"><img
                                    ...
                                    data-src="{{ URL::asset('index1/img/twitter_icon.svg') }}" alt="" class="lazy"></a>
                        </li>
                        @endif
                        ...
                        <li><a href="{{$this->store_info->facebook}}"><img
                                    src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                                    data-src="{{ URL::asset('index1/img/facebook_icon.svg') }}" alt="" class="lazy"></a>
                        </li>
                        @endif
                        ...
                        <li><a href="{{$this->store_info->youtube}}"><img
                                    src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                                    data-src="{{ URL::asset('index1/img/youtube_icon.svg') }}" alt="" class="lazy"></a>
                        </li>
                        @endif
            ...
            <div class="modal-body">
                <div class="col-12">
                    ...
                    <div class="dropify-wrapper" style="height:auto;border: none;">
                        ...
                        <input type="file" id='upload_img' class="dropify" wire:model="upload_image" data-height="210">
                    </div>
                    @error('upload_image')
