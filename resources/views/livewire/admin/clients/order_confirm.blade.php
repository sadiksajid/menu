                    ...
                    @elseif($checklocal == false and $edit_quartier_name == true)
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-2">
                                    <button wire:click="checkLoactionInfo()" wire:loading.attr="disabled" type="button"
                                        class="btn btn-danger mb-3" style="width: 100%;">Back</button>
                                </div>
                            </div>
                        </div>
                    @endif
                    ...
                    <div class=" row">
                                ...
                                <div class=" row">
                                    ...
                                    <div class="col-4">
                                        <button wire:loading.attr="disabled" type="button"
                                            ...
                                            style="width: 100%;"><i
                                                class="fe fe-phone mr-2"></i>{!! $agencyProject['Try_1'] !!}</button>
                                    </div>
                                    <div class="col-4">
                                        <button wire:loading.attr="disabled" type="button"
                                            @if ($sender_calls < 2) wire:click="sender_calls(2)" @endif
                                            class="btn {{ $sender_calls >= 2 ? 'btn-orange' : 'btn-light' }}"
                                            style="width: 100%;"><i
                                                class="fe fe-phone mr-2"></i>{!! $agencyProject['Try_2'] !!}</button>
                                    </div>
                                    <div class="col-4">
                                        <button wire:loading.attr="disabled" type="button"
                                            @if ($sender_calls < 3) wire:click="sender_calls(3)" @endif
                                            class="btn {{ $sender_calls >= 3 ? 'btn-red' : 'btn-light' }}"
                                            style="width: 100%;"><i
                                                class="fe fe-phone mr-2"></i>{!! $agencyProject['Try_2'] !!}</button>
                                    </div>
                                </div>
                        ...
                        <div class="col-12 mb-6">
                            <div class=" row">
                                ...
                                <div class="col-4">
                                    <button wire:click="receiver_calls(1)" wire:loading.attr="disabled" type="button"
                                        class="btn {{ $receiver_calls >= 1 ? 'btn-yellow' : 'btn-light' }} "
                                        style="width: 100%;"><i class="fe fe-phone mr-2"></i>Try 1</button>
                                </div>
                                <div class="col-4">
                                    <button wire:click="receiver_calls(2)" wire:loading.attr="disabled" type="button"
                                        class="btn {{ $receiver_calls >= 2 ? 'btn-orange' : 'btn-light' }}"
                                        style="width: 100%;"><i class="fe fe-phone mr-2"></i>Try 2</button>
                                </div>
                                <div class="col-4">
                                    <button wire:click="receiver_calls(3)" wire:loading.attr="disabled" type="button"
                    ...
                    <div class="col-4">
                        <div class="card mb-3" data-target=".modimg{{ $loop->index }}" data-toggle="modal">
                            ...
                            <div class="p-4 bg-light border border-bottom-0">
                                <div class="modal fade modimg{{ $loop->index }}" id="img{{ $loop->index }}"
            ...
            <div class="card">
                ...
                <div class="card-footer">
                    <div class="row">
                        ...
                        <div class="col-4">
                            <button wire:loading.attr="disabled" class="btn btn-info btn-block"
                                wire:click.prevent="saveComment()"><i class="fe fe-info"></i>
