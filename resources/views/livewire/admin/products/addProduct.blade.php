                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-2">
                                                ...
                                                <button type="button" class="btn btn-icon btn-info mb-4 float-right"
                                                    ...
                                                    <i class="fe fe-plus" wire:loading.remove
                                                        wire:target="newCategory"></i>
                                                </button>
                                            </div>
                                            ...
                                            <div class="col-md-4 col-6">
                                                ...
                                                <label class="custom-switch" style=" cursor:pointer ;padding: 8px; ">
                                                    <input type="checkbox" name="custom-switch-checkbox"
                                                        wire:model='status' class="custom-switch-input">
                                            ...
                                            <div class="col-md-4 col-6">
                                                <label class="col-md-12 form-label">{{ $translations['add_to_menu'] }}
                                                    <span class="text-red">*</span></label>
                                                <label class="custom-switch" style=" cursor:pointer ;padding: 8px;">
                                                    <input type="checkbox" name="custom-switch-checkbox"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5 col-12">
                                        ...
                                        <div class="dropify-wrapper" style="height:auto;border: none;">
                                            ...
                                            <input type="file" class="dropify" wire:model="cat_image"
                                                data-height="210">
                                        </div>
                                        @error('cat_image')
                                            <span class="text-danger">{{ $message }}</span>
                                                    ...
                                                    <div class="dropify-wrapper" style="height: auto">
                                                        ...
                                                        @else
                                                            <button style="position: absolute;margin-left: 10px;"
                                                                ...
                                                                wire:click.prevent="delete_image_edit()"><i
                                                                    class="fa fa-check"
                                                                    data-toggle="tooltip"></i></button>
                                                            <button style="position: absolute;margin-left: 50px;"
                                                                class="btn-sm btn-danger mt-2"
                                                                wire:click.prevent="no_delete_image_edit()"><i
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <div class="dropify-wrapper" style="height: auto">
                                                        ...
                                                        @else
                                                            ...
                                                            <button style="position: absolute;margin-left: 50px;"
                                                                class="btn-sm btn-danger mt-2"
                                                                wire:click.prevent="no_delete_image_tm()"><i
                                                                    class="fa fa-times" data-toggle="tooltip"
                                                                    title=""
                                                                    data-original-title="fa fa-times"></i></button>
                                                        @endif
                                    ...
                                    @foreach ($receipts as $key => $receipt)
                                        ...
                                        <div class="col-10">
                                            <input class="form-control mb-4"
                                                placeholder="{{ $translations['receipt'] }}" type="text"
                                        ...
                                        <div class="col-4 p-0">
                                            <div class="dropify-wrapper" style="height:auto;border: none;">
                                                ...
                                                <input type="file" class="dropify"
                                                    wire:model="extras.{{ $key }}.image" data-height="210">
                                            </div>
