                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-xl-9 col-lg-10 col-md-8">
                            <h1  > {{ $titles['title-1'] ?? $translations_resto['our_menu']['en'] }}  </h1>
                            <p  >{{ $titles['title-2'] ?? $translations_resto['our_menu_text']['en'] }} </p>
                        </div>
                    </div>
                    <!-- /row -->
                </div>
                    ...
                    @foreach ( $product as $prod)
                        <div class="col-lg-6" data-cue="slideInUp">
                            <div class="menu_item order">
                                ...
                                <a href="#0" class="add_to_cart" style="margin-left: 5px;background-color:{{$store_info->btn_color}}" wire:click="addToCart({{ $prod['id'] }},0)">{{$translations['add_to_cart']['en']}}</a>
                            </div>
                        </div>
                    @endforeach
                </div>
