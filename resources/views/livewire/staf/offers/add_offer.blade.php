                            ...
                            <div class="row p1-3" style="overflow: auto;max-height: 129vh">
                                ...
                                <div class="col-sm-12 col-6">
                                    ...
                                    <div class="card overflow-hidden">
                                        ...
                                        width: 100%;
                                        height: 200px;">
                                            <img src="{{ get_image('tmb/'.$product?->media[0]->media ?? 'pngs/food-icon.jpg') }}" onerror="this.onerror=null;this.src='https://minio-api.sys.coolrasto.com/menu/pngs/food-icon.jpg';"
                                                class="card-image1 ">
                                        </div>
                                        <div class="card-body p-2">
