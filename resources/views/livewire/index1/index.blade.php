...
<ul id="banners_grid" class="clearfix">
    <li class="">
        <a @if (isset($urls['url_1'])) href="{{$urls['url_1']}}" @else href="menu-1.html" @endif class="img_container  "
            data-id='url_1'>
    ...
    <li class="">
        <a @if (isset($urls['url_2'])) href="{{$urls['url_2']}}" @else href="menu-1.html" @endif class="img_container  "
            data-id='url_2'>
    ...
    <li class="">
        <a @if (isset($urls['url_3'])) href="{{$urls['url_3']}}" @else href="menu-1.html" @endif class="img_container  "
            data-id='url_3'>
    ...
    <div class="container margin_120_100 home_intro">
        <div class="row justify-content-center d-flex align-items-center">
            ...
            <div class="col-lg-5 pt-lg-4" data-cue="slideInUp" data-delay="500">
                ...
                <p><img src="{{ URL::asset('index1/img/signature.png') }}" width="140" height="50" alt="" class="mt-3">
                </p>
                ...
                <div class='col-12' >
                    <center>
                        <a @if (isset($urls['url_4'])) href="{{$urls['url_4']}}" @else
                            ...
                            data-cue="zoomIn" data-delay="500"
                            style='position:relative!important ; color: black;width: 190px;border-radius: 15px;background-color:#FAB100;margin-top: 90px;'><span
                                class=""><i class="arrow_triangle-right"></i><span style='font-size: 18px;float: right;margin-right: 10px;'>Watch
                                    Video</span></span> </a>
                    </center>
                </div>
            </div>
...
<div class="bg_gray">
    <div class="container margin_120_100" data-cue="slideInUp">
        ...
        <a href="/shop/offer/{{ $offer->offer_meta}}">
            ...
            <figure class="d-none d-lg-block"><img src="{{ URL::asset('index1/img/banner.svg') }}" alt="" width="200"
...
<div class="call_section lazy" @if (isset($images['img_7']))
    style="position: relative; background-image:get_image($images['img_7'])" data-bg="get_image($images['img_7'])" @else
    style="position: relative" data-bg="url({{ URL::asset('index1/img/bg_call_section.jpg') }})" @endif>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-5 col-md-6 text-center">
                ...
                <div class="box_1" data-cue="slideInUp">
                    ...
                    <h2 class='' data-id='title-14'> {{ $titles['title-14'] ?? $translations_resto['our_location'] }}
                    </h2>
    ...
    <div class="container margin_120_100 pb-0">
        <div class="row justify-content-center">
            <div class="col-lg-6 text-center d-none d-lg-block" data-cue="slideInUp" wire:ignore>
                ...
                <img src="{{ get_image($competition_img ?? '') }}" width="420" height="770" alt="" class="img-fluid">
                @else
                ...
                <div id="wizard_container">
                    ...
                    <center>
                        ...
                        <button type="button" name="process" class="submit mt-4" wire:click="DownloadQR()"
                            style='background-color:{{$store_info->btn_color}}' wire:loading.remove>
