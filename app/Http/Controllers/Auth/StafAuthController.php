...
class StafAuthController extends Controller
{
    ...
    protected $redirectTo = '/staf/products';
    ...
    public function login(Request $request)
    {
        ...
        if (Auth::guard('staf')->attempt(['email' => $request->email, 'password' => $request->password], $request->remember)) {
            return redirect()->intended(route('staf.products'));
        }
